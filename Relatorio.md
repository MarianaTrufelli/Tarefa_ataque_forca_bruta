...
- Os wordlists devem tinham possíveis usuários e senhas fracas/comuns.

## 3. Explorei o Serviço SMB

Verifiquei se o serviço estava disponível:
...
- Credenciais encontradas, mostrou:  
  `ACCOUNT FOUND: [smbnt] Host: 192.168.56.102 User: msfadmin Password: msfadmin`

## 5. Validei o Acesso com smbclient

```bash
smbclient -L //192.168.56.102 -U msfadmin
```
- Usei a senha descoberta (`msfadmin`). 
...
**Curso:** Cibersegurança Riachuelo/DIO  
